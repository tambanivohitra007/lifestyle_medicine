    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between print:hidden">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Treatment guide format</p>
          </div>
        </div>
      ...
      <div className="card max-w-4xl mx-auto treatment-guide print:shadow-none print:p-0">
        ...
        <div className="text-center mb-8">
          ...
          {condition.category && (
            <p className="text-gray-600 mt-2">{condition.category}</p>
          )}
        </div>
                ...
                {domainInterventions.map((intervention) => (
                  ...
                  >
                    ...
                    {intervention.pivot?.clinical_notes && (
                      <p className="text-gray-600 text-sm mt-1 bg-yellow-50 p-2 rounded">
          ...
          <div className="section">
            ...
            <div className="space-y-4">
              {scriptures.map((scripture) => (
                <blockquote key={scripture.id} className="border-l-4 border-indigo-300 pl-4 py-2 bg-indigo-50">
