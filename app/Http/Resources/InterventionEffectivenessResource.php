...
/**
 * API resource for transforming InterventionEffectiveness model instances.
 *
 * Includes effectiveness rating, computed score, evidence grade,
 * primary intervention flag, notes, and related condition/intervention data.
 */
